...
#define PINGROUPS	\
	...
	PINGROUP(GPIO_PBB3,	  PBB3,		CAM,	    VGP3,	RSVD1,      DISPLAYA,	DISPLAYB,	     RSVD,	INPUT,	0x3298),\
	PINGROUP(GPIO_PBB4,	  PBB4,		CAM,	    VGP4,	RSVD1,      DISPLAYA,	DISPLAYB,	     RSVD,	INPUT,	0x329c),\
	PINGROUP(GPIO_PBB5,	  PBB5,		CAM,	    VGP5,	RSVD1,      DISPLAYA,	DISPLAYB,	     RSVD,	INPUT,	0x32a0),\
	PINGROUP(GPIO_PBB6,	  PBB6,		CAM,	    VGP6,	RSVD1,      DISPLAYA,	DISPLAYB,	     RSVD,	INPUT,	0x32a4),\
	...
	PINGROUP(SDMMC3_CLK_LB_OUT,	  PEE4,		SDMMC3,        SDMMC3,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3400),\
