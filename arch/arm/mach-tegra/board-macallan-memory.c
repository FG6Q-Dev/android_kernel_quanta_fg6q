...
static struct tegra11_emc_table fg6q_elpida_T40S_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
...
static struct tegra11_emc_pdata fg6q_elpida_T40S_pdata = {
	.description = "fg6q_elpida_T40S",
	.tables = fg6q_elpida_T40S_table,
	.num_tables = ARRAY_SIZE(fg6q_elpida_T40S_table),
};

static struct tegra11_emc_table fg6q_micron_T40S_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		900,        /* min voltage */
...
static struct tegra11_emc_pdata fg6q_micron_T40S_pdata = {
	.description = "fg6q_micron_T40S",
	.tables = fg6q_micron_T40S_table,
	.num_tables = ARRAY_SIZE(fg6q_micron_T40S_table),
};
...
static struct tegra11_emc_pdata *macallan_get_emc_data(void)
{
	...
	printk(KERN_INFO "%s: ramcodes value %d\n", __func__, ret);

	switch (ret) {
	case HW_RAMCODES_ELPIDA:
		return &fg6q_elpida_T40S_pdata;
		break;
	case HW_RAMCODES_MICRON:
		return &fg6q_micron_T40S_pdata;
		break;
	...
	case HW_RAMCODES_HYNIX:
		...
		break;
	default:
		printk(KERN_ERR "%s: Not support ramcodes value %d\n", __func__, ret);
		return &e1545_h5tc4g63mfr_pba_T40S_pdata;
	}
}
...
{
	printk(KERN_ERR "RYINFO: support new DVFS-0814!\n");
