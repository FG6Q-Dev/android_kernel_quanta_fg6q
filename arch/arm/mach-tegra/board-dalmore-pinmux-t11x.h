...
/* DO NOT EDIT THIS FILE. THIS FILE IS GENERATED FROM WAYNE_PINMUX.XLSM */
...
static __initdata struct tegra_pingroup_config dalmore_pinmux_common[] = {
	...
	/* SPI6 pinmux */
	DEFAULT_PINMUX(GPIO_X6_AUD,   SPI6,        PULL_UP,   NORMAL,   INPUT),
	...
	/* USB pinmux */
	DEFAULT_PINMUX(SPDIF_IN,      USB,         PULL_UP,   NORMAL,   INPUT),
	DEFAULT_PINMUX(USB_VBUS_EN0,  USB,         PULL_UP,   NORMAL,   INPUT),

	/* io rdy */
	DEFAULT_PINMUX(GMI_IORDY,       GMI,         PULL_UP,   NORMAL, INPUT),
	/* GPIO pinmux */
	GPIO_PINMUX(GPIO_X4_AUD, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	...
	GPIO_PINMUX(GPIO_X1_AUD, PULL_DOWN, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GPIO_X3_AUD, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(DAP3_DIN, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(DAP3_DOUT, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(DAP3_FS, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	...
	GPIO_PINMUX(GPIO_PBB3, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PBB4, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PBB5, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PBB6, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PBB7, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	...
	GPIO_PINMUX(GMI_AD11, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD12, NORMAL, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GMI_AD13, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD14, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD15, NORMAL, NORMAL, INPUT, DISABLE),
	...
	GPIO_PINMUX(GMI_AD8, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_ADV_N, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GMI_CLK, PULL_DOWN, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_CS0_N, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GMI_CS2_N, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GMI_CS3_N, PULL_UP, NORMAL, OUTPUT, DISABLE),
	...
	GPIO_PINMUX(KB_COL3, PULL_UP, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(KB_COL5, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(KB_COL6, PULL_UP, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(KB_COL7, PULL_UP, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(KB_ROW3, PULL_DOWN, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(KB_ROW4, PULL_DOWN, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(KB_ROW5, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(KB_ROW6, PULL_DOWN, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(KB_ROW7, NORMAL, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(KB_ROW8, PULL_DOWN, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(CLK3_REQ, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PU0, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PU1, NORMAL, NORMAL, INPUT, DISABLE),
